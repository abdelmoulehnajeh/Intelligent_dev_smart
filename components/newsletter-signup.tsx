      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-card border border-border rounded-2xl p-8 md:p-12">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-2">{t("newsletter.title")}</h2>
          ...
          {submitted ? (
            <div className="flex items-center gap-3 p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
              ...
              <div>
                <p className="font-semibold text-green-900">{t("newsletter.success")}</p>
                <p className="text-sm text-green-800">{t("newsletter.successDesc")}</p>
              </div>
            </div>
          ) : (
